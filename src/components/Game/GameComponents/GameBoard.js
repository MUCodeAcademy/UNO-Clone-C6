...
import {Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle} from '@material-ui/core';
 ...
 const GameBoard = (props) => {
    ...
    const {drawCard, canPlay, isHost, startGame, quitGame, regularTurn, setColor, gameActive, setGameActive} = useContext(GameContext)
    ...
    return (
      ...
      >
        ...
        <DialogContent>
          ...
          <Alert severity="error" className="alert">You have {msg} to make a choice or lose a turn!</Alert>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={()=>{setOpen(false)}} color="primary">
            ...
            <div className="thebigthree">
                <div className="drawContainer">
                    <div style={{ backgroundColor: "black" }} className={`cardback`} onClick={() => { 
                        drawCard(); setDrawedCard(true) 
                        }}>
                    </div>
                </div>
                ...
                <div className="conditionContainer">
                    ...
                    {drawedCard && <Button variant="contained"
                        ...
                        onClick={() => { 
                            regularTurn(); setDrawedCard(false) 
                        }}
                    >Next Turn</Button>}

                    <div className="color-area">
                        <div className="color-box" style={{ backgroundColor: "blue" }} 
                        ...
                        ></div>
                        <div className="color-box" style={{ backgroundColor: "yellow" }} 
